...
from ..knowledge_engineering.router import RoutingResult
...
class SearchResult:
    ...
    Attributes:
        ...
        routing: RoutingResult when the router was used; None otherwise.
        sources_searched: List of source types searched (populated by multi-source).
    """
